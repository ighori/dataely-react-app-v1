...
export const BusinessUnit = (props: RouteComponentProps<{ url: string }>) => {
            ...
            <tbody>
              {businessUnitList.map((businessUnit, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {businessUnit.creationDate ? (
                      <TextFormat type="date" value={businessUnit.creationDate} format={APP_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {businessUnit.lastUpdated ? <TextFormat type="date" value={businessUnit.lastUpdated} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${businessUnit.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${businessUnit.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
