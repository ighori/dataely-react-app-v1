          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Business Unit <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {projectList.map((project, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{project.lastUpdated ? <TextFormat type="date" value={project.lastUpdated} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>
                    {project.businessUnit ? <Link to={`business-unit/${project.businessUnit.id}`}>{project.businessUnit.name}</Link> : ''}
                  </td>
