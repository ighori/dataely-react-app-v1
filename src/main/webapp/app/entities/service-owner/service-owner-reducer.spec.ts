...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEOWNER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SERVICEOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SERVICEOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SERVICEOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SERVICEOWNER actions', async () => {
      const expectedActions = [
        {
