...
import com.dataely.app.repository.ProjectRepository;
import com.dataely.app.service.dto.ProjectDTO;
import com.dataely.app.service.mapper.ProjectMapper;
...
class ProjectResourceIT {
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.code(UPDATED_CODE).creationDate(UPDATED_CREATION_DATE).lastUpdated(UPDATED_LAST_UPDATED);
