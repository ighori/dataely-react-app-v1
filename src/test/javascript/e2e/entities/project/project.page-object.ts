...
export class ProjectDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('dataelyReactAppV1App.project.delete.question'));
...
export default class ProjectComponentsPage {
  ...
  async deleteProject() {
    ...
    expect(await projectDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/dataelyReactAppV1App.project.delete.question/);
